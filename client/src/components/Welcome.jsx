			...
			<div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
				...
				<div className="flex flex-1 justify-start flex-col mf:mr-10">
					...
					<div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
						<div className={`rounded-tl-2xl ${gridCommonStyles}`}>Reliablity</div>
						<div className={gridCommonStyles}>Security</div>
						<div className={`sm:rounded-tr-2xl ${gridCommonStyles}`}>Ethereum</div>
						<div className={`sm:rounded-bl-2xl ${gridCommonStyles}`}>Web 3.0</div>
						<div className={gridCommonStyles}>Low fees</div>
						<div className={`rounded-br-2xl ${gridCommonStyles}`}>Blockchain</div>
					</div>
				</div>
